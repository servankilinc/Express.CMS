...
{
    public class SolutionGroupUpdateDto : IDto
    {
    ...
    public class SolutionGroupUpdateDtoValidator : AbstractValidator<SolutionGroupUpdateDto>
    {
        public SolutionGroupUpdateDtoValidator()
        {
