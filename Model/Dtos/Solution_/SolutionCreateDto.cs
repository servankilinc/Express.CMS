...
{
    public class SolutionCreateDto : IDto
    {
    ...
    public class SolutionCreateDtoValidator : AbstractValidator<SolutionCreateDto>
    {
        ...
        {
            RuleFor(v => v.SolutionGroupId).NotNull().WithMessage("Çözüm grubu boş geçilemez.");
