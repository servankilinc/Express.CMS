...
namespace WebAPI.Controllers
{
    ...
    public class MenuController : ControllerBase
    {
        ...
        {
            var result = await _menuService.GetAllAsync(request);
            if (result == null)
            {
                return NotFound();
            }
        ...
        {
            var result = await _menuService.GetByBasicAsync(id);
            if (result == null)
            {
                return NotFound();
            }
        ...
        {
            var result = await _menuService.GetAllByBasicAsync(request);
            if (result == null)
            {
                return NotFound();
            }
        ...
        {
            var result = await _menuService.GetListByBasicAsync(request);
            if (result == null)
            {
                return NotFound();
            }
        ...
        [HttpPost("Create")]
        public async Task<IActionResult> Create(MenuCreateDto request)
        {
        ...
        [HttpPatch("Update")]
        public async Task<IActionResult> Update(MenuUpdateDto request)
        {
        ...
        {
            var result = await _menuService.DatatableClientSideAsync(request);
            if (result == null)
            {
                return NotFound();
            }
